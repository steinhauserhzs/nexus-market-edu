-- Temporarily remove foreign key constraint and create demo data
DO $$ 
DECLARE
    store_id_var UUID;
...
BEGIN
    ...
    IF store_id_var IS NULL THEN
        ...
        ALTER TABLE public.stores DISABLE TRIGGER ALL;
        ...
        ALTER TABLE public.stores ENABLE TRIGGER ALL;
