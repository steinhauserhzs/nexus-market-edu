...
-- Drop existing function first, then recreate with correct signature
DROP FUNCTION IF EXISTS public.get_venue_public_data(uuid);

-- Create a function to get a single venue's public data (matching actual table structure)
